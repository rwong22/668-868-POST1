...
public class ItemTuple implements Serializable {
     ...
     * 
     * @param UPC
     *            of each Item scanned from the customer cart
     * @param quantity
     *            per Item from the customer cart
     */
    ...
    /**
     * @param UPC
     *            scanned for the item from the Customer cart
     */
    ...
    /**
     * @param quantity
     *            of the each item in the customer cart
     */
